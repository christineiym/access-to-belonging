export default function GameInstructions() {
  return (
      <div className="p-6 flex flex-col md:flex-row justify-center items-center gap-8 text-white font-sans">
        {/* How to Play */}
        <div className="bg-darkPurple p-4 rounded-md shadow-lg max-w-sm">
        ...
        {/* Going Up / Down */}
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 bg-darkPurple p-4 rounded-md shadow-lg">
          {/* Up */}
          <div className="flex flex-row items-center gap-4 pr-4">
            <div>
              <p className="text-lg font-bold mb-2">Going Up</p>
              <p className="text-normal">If you land on a crosswalk, move up!</p>
            </div>
          ...
          <div className="flex flex-row items-center gap-4 pr-4">
            <div>
              ...
              <p className="text-normal">If you land on construction tape, move down.</p>
            </div>
